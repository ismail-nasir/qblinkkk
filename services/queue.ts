...
export const queueService = {
  ...
  joinQueue: async (queueId: string, name: string): Promise<{ visitor: Visitor, queueData: QueueData }> => await api.post('/queue/join', { queueId, name }),
  ...
  // Export/Import not supported in cloud version initially (could implement as file upload API)
