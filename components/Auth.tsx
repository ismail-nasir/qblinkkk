...
const Auth: React.FC<AuthProps> = ({
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!formData.agreedPrivacy)
        throw new Error('You must acknowledge the Privacy Policy.');
          ...
          <form onSubmit={handleSignup} className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                  {passwordCriteria.map((criterion, i) => (
                    ...
                    >
                      ...
                      <span
                        className={
                          criterion.valid ? 'text-green-600 font-medium' : ''
                        }
                      >
                        {criterion.label}
                      </span>
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-start gap-3">
                <div
                  className={`w-5 h-5 mt-0.5 rounded-md border flex items-center justify-center cursor-pointer transition-colors flex-shrink-0 ${
          ...
          <form onSubmit={handleVerify} className="space-y-6">
            ...
            <div className="text-center">
              <button
                ...
                className="text-sm text-gray-500 font-semibold hover:text-primary-600"
              >
          ...
          <form onSubmit={handleForgot} className="space-y-6">
            ...
            <div className="text-center">
              <button
                ...
                className="flex items-center justify-center gap-2 text-sm text-gray-500 font-semibold hover:text-gray-800 mx-auto"
              >
  ...
  const titles: Record<AuthView, { title: string; subtitle: string }> = {
    ...
    signup: {
      ...
      subtitle: 'Start managing queues in 30 seconds',
    },
    verify: {
      title: 'Verify Email',
  ...
  return (
    <div className="min-h-screen w-full flex bg-white animate-fade-in">
      ...
      <div className="hidden lg:flex w-[45%] bg-blue-50/50 relative overflow-hidden flex-col justify-between p-12 lg:p-16">
        ...
        <div className="relative z-10">
          <div
            ...
            className="flex items-center gap-2 cursor-pointer mb-12 hover:opacity-70 transition-opacity w-fit"
          >
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-8 leading-tight">
            Join 500+ businesses delivering exceptional customer experiences
            with zero friction.
          </h2>
        ...
        <div className="relative z-10 bg-white rounded-3xl p-6 shadow-xl shadow-blue-900/5 border border-white mt-12">
          <p className="text-gray-600 italic text-lg mb-4">
            "Qlink transformed our customer experience. Wait times down 40%,
            satisfaction up 60%."
          </p>
      ...
      <div className="w-full lg:w-[55%] flex flex-col justify-center items-center p-6 md:p-12 lg:p-24 relative">
        ...
        <button
          onClick={onBack}
          className="absolute top-6 left-6 lg:hidden flex items-center gap-2 text-gray-500 hover:text-gray-900"
        >
          <ArrowLeft size={20} /> Back
        </button>

        {/* Desktop back button on form side */}
        <button
          onClick={onBack}
          className="hidden lg:inline-flex absolute top-8 right-8 items-center gap-2 px-4 py-2 rounded-full bg-white/80 text-gray-600 text-sm font-medium shadow-sm border border-gray-200 hover:bg-white hover:text-gray-900 transition-colors"
        >
          ...
          <div className="text-center lg:text-left">
            {view === 'signup' && (
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-xs font-bold mb-4"
              >
