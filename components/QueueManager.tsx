...
import { motion as m, AnimatePresence, Reorder as R, useDragControls } from 'framer-motion';
// @ts-ignore
...
const QueueManager: React.FC<QueueManagerProps> = ({ user, queue, onBack }) => {
  ...
  const generateCustomQRCode = async () => {
    ...
    // Embed params for hydration if needed in cross-device (no cloud) mode
  ...
  // ... (Rest of component methods - handleLogoUpload, handleSaveSettings, etc. remain unchanged) ...
                      ...
                      <div className="bg-gray-50 p-4 rounded-2xl space-y-3">
                          ...
                          <div className="flex justify-between items-center">
                              ...
                              <button onClick={() => setSettings({...settings, enableSMS: !settings.enableSMS})}>
                                  {settings.enableSMS ? <ToggleRight size={24} className="text-primary-600" /> : <ToggleLeft size={24} className