...
const Dashboard: React.FC<DashboardProps> = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-transparent pb-20 animate-fade-in">
      {/* Navbar */}
      ...
      <main className="container mx-auto px-6 pt-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
          ...
          <button 
            ...
            disabled={loadingAi}
            className="flex items-center gap-2 px-5 py-3 bg-white/80 border border-indigo-100 text-indigo-600 rounded-2xl shadow-sm hover:bg-indigo-50 transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:scale-100 animate-fade-in-up animation-delay-100"
          >
            ...
            <div className="mb-8 animate-pop-in">
                <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-[24px] p-1 shadow-lg">
                    <div className="bg-white/95 backdrop-blur-sm rounded-[22px] p-6 flex items-start gap-4">
                        <div className="p-3 bg-indigo-100 rounded-xl animate-pulse">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 animate-fade-in-up animation-delay-200">
            <GlassCard className="p-10 flex flex-col items-center justify-center text-center relative overflow-hidden min-h-[400px]">
               ...
               {/* Animated Number */}
               <div key={currentTicket} className="text-[120px] md:text-[160px] leading-none font-bold text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 to-indigo-400 tracking-tighter drop-shadow-sm animate-pop-in">
               ...
               <div className="mt-12 w-full max-w-md flex flex-col gap-4">
                 <button 
                    ...
                    className="group w-full py-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl text-xl font-bold shadow-xl shadow-indigo-500/20 hover:shadow-indigo-500/40 hover:-translate-y-1 active:translate-y-0 transition-all flex items-center justify-center gap-3 overflow-hidden relative"
                 >
                    {/* Shimmer overlay */}
                    ...
                    <span className="relative z-10 flex items-center gap-3">Call Next Customer <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" /></span>
                 </button>
                 
                 <div className="grid grid-cols-2 gap-4">
                    <button 
                        onClick={() => {}} 
                        className="py-4 bg-white border border-gray-200 text-gray-600 rounded-2xl font-semibold hover:bg-gray-50 hover:border-gray-300 transition-all flex items-center justify-center gap-2 active:scale-95"
                    >
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 animate-fade-in-up animation-delay-300">
             ...
             <GlassCard className="p-8">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex items-center gap-2 px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-bold uppercase">
