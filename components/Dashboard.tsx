      ...
      <main className="container mx-auto px-4 md:px-6 pt-8 md:pt-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-10 gap-6">
          ...
          <button 
            ...
            disabled={loadingAi}
            className="w-full md:w-auto flex items-center justify-center gap-2 px-5 py-3 bg-white/80 border border-indigo-100 text-indigo-600 rounded-2xl shadow-sm hover:bg-indigo-50 transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:scale-100 animate-fade-in-up animation-delay-100"
          >
            ...
            <div className="mb-8 animate-pop-in">
                <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-[24px] p-1 shadow-lg">
                    <div className="bg-white/95 backdrop-blur-sm rounded-[22px] p-4 md:p-6 flex items-start gap-4">
                        <div className="hidden sm:block p-3 bg-indigo-100 rounded-xl animate-pulse">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 animate-fade-in-up animation-delay-200">
            <GlassCard className="p-6 md:p-10 flex flex-col items-center justify-center text-center relative overflow-hidden min-h-[350px] md:min-h-[400px]">
               ...
               {/* Animated Number - Responsive Font Size */}
               <div key={currentTicket} className="text-8xl sm:text-9xl md:text-[160px] leading-none font-bold text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 to-indigo-400 tracking-tighter drop-shadow-sm animate-pop-in py-2">
